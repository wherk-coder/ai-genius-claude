...
async function main() {
  ...
  const teams = [
    // NFL Teams
    { name: 'Kansas City Chiefs', abbreviation: 'KC', sport: 'NFL', externalId: 'nfl-kc' },
    { name: 'Buffalo Bills', abbreviation: 'BUF', sport: 'NFL', externalId: 'nfl-buf' },
    { name: 'Miami Dolphins', abbreviation: 'MIA', sport: 'NFL', externalId: 'nfl-mia' },
    
    // NBA Teams
    { name: 'Los Angeles Lakers', abbreviation: 'LAL', sport: 'NBA', externalId: 'nba-lal' },
    { name: 'Boston Celtics', abbreviation: 'BOS', sport: 'NBA', externalId: 'nba-bos' },
    { name: 'Golden State Warriors', abbreviation: 'GSW', sport: 'NBA', externalId: 'nba-gsw' },
  ];
